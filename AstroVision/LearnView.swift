...
class LearnView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        backButton.titleLabel?.font = UIFont(name: "AvenirNext-Bold", size: 18)
        ...
        // Set up constraints for the title label, content text view, and back button
        NSLayoutConstraint.activate([
            ...
            contentTextView.bottomAnchor.constraint(equalTo: backButton.topAnchor, constant: -20), // Prevents overlap with back button
    ...
    @objc private func backButtonTapped() {
        // Dismiss the LearnView and return to the previous view
